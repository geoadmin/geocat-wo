...
public class LocalFilesystemHarvester extends AbstractHarvester<HarvestResult, LocalFilesystemParams> {
    ...
    void runBeforeScript() throws IOException, InterruptedException {
    ...
    private boolean isScriptAllowed(List<String> args) {
        ...
        if(scriptFile == null) {
            ...
            throw new RuntimeException("The beforeScript can't be null.");
        }
        if(scriptFile.contains("..")) {
            log.warning("The beforeScript can't contains '..'.");
            throw new RuntimeException("The beforeScript can't contains '..'.");
        }
        ...
        if (argsWithSemiColon.size() > 0) {
            ...
            throw new RuntimeException("The beforeScript can't contains ';'. Only one script can be triggered.");
        }
        return true;
    }
}
